...
>
> Актуальная версия того, что лежало здесь: [`mcp/yandex-direct-mcp/`](https://github.com/theYahia/YaAll/tree/main/mcp/yandex-direct-mcp)
>
...
> package now lives at [`mcp/yandex-direct-mcp/`](https://github.com/theYahia/YaAll/tree/main/mcp/yandex-direct-mcp). Please open issues and pull requests there.
