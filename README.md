...
| Инструмент | Описание |
|------------|----------|
| `list_campaigns` | Список кампаний с фильтрацией по статусу и типу (с минус-фразами) |
| `get_campaign` | Детальная информация о кампании по ID (с минус-фразами) |
| `create_campaign` | Создать новую кампанию |
| `update_campaign` | Обновить кампанию (название, бюджет, статус) |
| `list_ad_groups` | Группы объявлений выбранных кампаний (с минус-фразами) |
