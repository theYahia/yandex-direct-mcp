...
## [4.2.0-seedon.1] — 2026-07-23

### Added
- 18 MCP-инструментов для уточнений, модерации, изображений, ретаргетинга, аудиторных и динамических целей, фидов, общих минус-фраз, изменений, визиток и организаций.
- Все числовые ID новых сервисов проходят через lossless BigInt-сериализацию.
